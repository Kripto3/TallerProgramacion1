...
<html lang="en">
  <head>
    ...
    <link href="assets/css/naturaleza.css" rel="stylesheet"> 
  </head>
  <body>
    <section class="container-fluid">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse margin margin-izq" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <li class="nav-item active">
                <a class="nav-link" href="#">Biomas<span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Especies</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Geograf&iacute;a</a>
              </li>
            </ul>
          </div>
        </nav>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="assets/img/bioma1.jpg" class="d-block w-100" alt="Bioma Dia">
          </div>
          <div class="carousel-item">
            <img src="assets/img/bioma2.png" class="d-block w-100" alt="Bioma nublado">
          </div>
          <div class="carousel-item">
            <img src="assets/img/bioma3.jpg" class="d-block w-100" alt="Bioma atardecer">
          </div>
        </div>
    ...
    <footer class="w-100 bg-secondary h-80 mt-5">
    </footer>
