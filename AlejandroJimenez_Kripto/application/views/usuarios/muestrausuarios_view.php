		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php foreach($usuarios->result() as $row) { ?>	
					...
					<td>
						<a class="text-success" href="<?php echo base_url("modifica_usuario/$row->id_usuario");?>"><i class="fa fa-edit"></i> Modificar</a> | 
						<a class="text-danger" href="<?php echo base_url("baja_usuario/$row->id_usuario");?>"><i class="fa fa-trash"></i> Dar de baja</a></td>
